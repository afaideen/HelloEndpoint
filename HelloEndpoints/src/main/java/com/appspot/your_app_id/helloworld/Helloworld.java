...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://3-dot-playchat-53073.appspot.com/_ah/api/";//work ok!
//  public static final String DEFAULT_ROOT_URL = "http://10.44.6.19:8080/_ah/api/";//tested ok!
  /**
  ...
  public class Greetings {
    ...
    public class Authed extends HelloworldRequest<com.appspot.your_app_id.helloworld.model.HelloGreeting> {
       ...
       */
      protected Authed() {
        super(Helloworld.this, "POST", REST_PATH, null, com.appspot.your_app_id.helloworld.model.HelloGreeting.class);
      }
    ...
    public class GetGreeting extends HelloworldRequest<com.appspot.your_app_id.helloworld.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.your_app_id.helloworld.model.HelloGreeting.class);
    ...
    public class ListGreeting extends HelloworldRequest<com.appspot.your_app_id.helloworld.model.HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.your_app_id.helloworld.model.HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link com.appspot.your_app_id.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.your_app_id.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.appspot.your_app_id.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.your_app_id.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.appspot.your_app_id.helloworld.model.HelloGreeting.class);
