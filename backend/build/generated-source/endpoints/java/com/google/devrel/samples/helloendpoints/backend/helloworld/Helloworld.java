...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the helloworld library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Greetings {
    ...
    public class Authed extends HelloworldRequest<com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting> {
       ...
       */
      protected Authed() {
        super(Helloworld.this, "POST", REST_PATH, null, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting.class);
      }
    ...
    public class GetGreeting extends HelloworldRequest<com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting.class);
    ...
    public class ListGreeting extends HelloworldRequest<com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.google.devrel.samples.helloendpoints.backend.helloworld.model.HelloGreeting.class);
